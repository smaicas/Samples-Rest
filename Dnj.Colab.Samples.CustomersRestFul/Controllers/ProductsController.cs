...
namespace Dnj.Colab.Samples.CustomersRestFul.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Dateofsale,Price,State")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Dateofsale,Price,State")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
