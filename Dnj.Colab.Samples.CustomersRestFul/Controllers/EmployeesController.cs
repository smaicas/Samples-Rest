...
namespace Dnj.Colab.Samples.CustomersRestFul.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Cellphone,Dni,Dateofcreation")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Cellphone,Dni,Dateofcreation")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
